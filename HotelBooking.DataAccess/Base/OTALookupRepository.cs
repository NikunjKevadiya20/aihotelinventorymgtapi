...
{
    public class OTALookupRepository : IOTALookupRepositoryInterface
    {

        #region Global Variables
        private readonly IDbConnection _dbConnection;
        private readonly ILogger<OTALookupRepository> logger;
        #endregion

        public OTALookupRepository(ILogger<OTALookupRepository> _logger, IDbConnection dbConnection)
        {
            logger = _logger;
        ...
        #region Insert OTA
        public async Task<ResultModel> InsertOTA(OTAEntity entity, string storedProcedure)
        {
        ...
        #region Update OTA
        public async Task<ResultModel> UpdateOTA(OTAEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
        ...
        #region Delete OTA
        public async Task<ResultModel> DeleteOTA(OTAIDEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
        ...
        #region FindBy ID OTA
        public async Task<OTAViewEntity> FindByIDOTA(OTAIDEntity entity, string storedProcedure)
        {
            OTAViewEntity result = new OTAViewEntity();
            ...
            try
            {
                ...
                var data = await _dbConnection.QuerySingleOrDefaultAsync<OTAViewEntity>(storedProcedure, dynamicParameters, commandType: CommandType.StoredProcedure);
                return data;
        ...
        #region Find All OTA
        public async Task<List<OTAViewEntity>> FindAllOTA(OTAIDEntity entity, string storedProcedure)
        {
            OTAViewEntity result = new OTAViewEntity();
            ...
            try
            {
                ...
                var data = await _dbConnection.QueryAsync<OTAViewEntity>(storedProcedure, dynamicParameters, commandType: CommandType.StoredProcedure);
                return data.ToList();
        ...
        #region Find All Active OTA
        public async Task<List<OTAViewEntity>> FindAllActiveOTA(string storedProcedure)
        {
            OTAViewEntity result = new OTAViewEntity();
        ...
        #region Active InActive OTA
        public async Task<ResultModel> ActiveInActiveOTA(OTAIDEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
