...
{
    public class FestivalsViewRepository : IFestivalsViewRepositoryInterface
    {
        // logger in every operations Added by AI009 on 25-03-23

        private readonly IDbConnection _dbConnection;

        private readonly ILogger<FestivalsViewRepository> logger;

        public FestivalsViewRepository(ILogger<FestivalsViewRepository> _logger, IDbConnection dbConnection)
        {
            logger = _logger;
        ...
        public async Task<ResultModel> InsertFestivals(FestivalEntity entity, string storedProcedure)
        {
        ...
        public async Task<ResultModel> UpdateFestivals(FestivalEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
        ...
        public async Task<List<FestivalsEntity>> FindAllFestivals(string storedProcedure)
        {
            FestivalsEntity result = new FestivalsEntity();
            try
            {
                ...
                var data = await _dbConnection.QueryAsync<FestivalsEntity>(storedProcedure, dynamicParameters, commandType: System.Data.CommandType.StoredProcedure);
        ...
        public async Task<List<FestivalsEntity>> FindAllActiveFestivals(string? Title, string storedProcedure)
        {
            FestivalsEntity result = new FestivalsEntity();
            try
            {
        ...
        public async Task<FestivalsEntity> FindByIDFestivals(FestivalsViewEntity entity, string storedProcedure)
        {
            FestivalsEntity result = new FestivalsEntity();
            try
            {
                ...
                var data = await _dbConnection.QueryFirstOrDefaultAsync<FestivalsEntity>(storedProcedure, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public async Task<ResultModel> DeleteFestivals(FestivalsViewEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
        ...
        public async Task<ResultModel> ActiveInActiveFestivals(FestivalsViewEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
