...
{
    public class FAQLookupRepository : IFAQLookupRepositoryInterface
    {
        #region Global Variables
        private readonly IDbConnection _dbConnection;
        private readonly ILogger<FAQLookupRepository> logger;
        #endregion

        public FAQLookupRepository(ILogger<FAQLookupRepository> _logger, IDbConnection dbConnection)
        {
            logger = _logger;
        ...
        #region Insert FAQ
        public async Task<ResultModel> InsertFAQ(FAQEntity entity, string storedProcedure)
        {
        ...
        #region Update FAQ
        public async Task<ResultModel> UpdateFAQ(FAQEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
        ...
        #region Delete FAQ
        public async Task<ResultModel> DeleteFAQ(FAQIDEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
        ...
        #region FindBy ID FAQ
        public async Task<FAQDataViewEntity> FindByIDFAQ(FAQIDEntity entity, string storedProcedure)
        {
            FAQDataViewEntity result = new FAQDataViewEntity();
            ...
            try
            {
                ...
                var data = await _dbConnection.QuerySingleOrDefaultAsync<FAQDataViewEntity>(storedProcedure, dynamicParameters, commandType: CommandType.StoredProcedure);
                return data;
        ...
        #region Find All FAQ
        public async Task<List<FAQDataViewEntity>> FindAllFAQ(FAQIDEntity entity, string storedProcedure)
        {
            FAQDataViewEntity result = new FAQDataViewEntity();
            ...
            try
            {
                ...
                var data = await _dbConnection.QueryAsync<FAQDataViewEntity>(storedProcedure, dynamicParameters, commandType: CommandType.StoredProcedure);
                return data.ToList();
        ...
        #region Find All Active FAQ
        public async Task<List<FAQDataViewEntity>> FindAllActiveFAQ(string storedProcedure)
        {
            FAQDataViewEntity result = new FAQDataViewEntity();
        ...
        #region Active InActive FAQ
        public async Task<ResultModel> ActiveInActiveFAQ(FAQIDEntity entity, string storedProcedure)
        {
            ResultModel result = new ResultModel();
