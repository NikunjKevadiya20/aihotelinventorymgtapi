...
namespace HotelBooking.Controllers
{
    ...
    {
        private readonly IWebsiteDomain domain;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public WebsiteController(ILogger<WebsiteController> _logger, IWebsiteDomain _WebsiteDomain)
        {
            domain = _WebsiteDomain;
        }
        ...
        public async Task<IActionResult> HomePageList()
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.HomePageList();
        ...
        #region FindAllSAOUTicketList
        [HttpGet("FindAllSAOUTicketList")]
        public async Task<IActionResult> FindAllSAOUTicketList()
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.FindAllSAOUTicketList();
        ...
        #region findby tour url
        [HttpPost("TourDetailsByURL")]
        public async Task<IActionResult> TourDetailsByURL(TourByURLEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.TourDetailsByURL(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        #region FindAnalyticsCount
        [HttpPost("FindAnalyticsCount")]
        public async Task<IActionResult> FindAnalyticsCount(AnalyticsCountEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.FindAnalyticsCount(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("InsertBookingReference")]

        public async Task<IActionResult> InsertBookingReference(BookingReferenceEntity entity)
        {
            try
            {
                int userId = 1;
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.InsertBookingReference(entity);
        ...
        [HttpPost("FindAllBookingReference")]
        [Authorize]
        public async Task<IActionResult> FindAllBookingReference(BookingReferenceEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.FindAllBookingReference(entity);
                    if (result[0].Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
