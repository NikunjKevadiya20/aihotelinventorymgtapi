...
namespace AMTAPI.Controllers
{
    ...
    {
        private readonly IFestivalsDomain domain;

        public FestivalsController(ILogger<FestivalsController> _logger, IFestivalsDomain _regionsDomain)
        {
        ...
        [HttpPost("InsertFestivals")]
        [Authorize]
        public async Task<IActionResult> InsertFestivals(FestivalEntity entity)
        {
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.InsertFestivals(entity);
        ...
        [HttpPost("UpdateFestivals")]
        [Authorize]
        public async Task<IActionResult> UpdateFestivals(FestivalEntity entity)
        {
            try
            {
                var token = HttpContext.Request.Headers["Authorization"]
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.UpdateFestivals(entity);
        ...
        [HttpGet("FindAllFestivals")]
        [Authorize]
        public async Task<IActionResult> FindAllFestivals()
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.FindAllFestivals();
        ...
        [HttpGet("FindAllActiveFestivals")]
        [Authorize]
        public async Task<IActionResult> FindAllActiveFestivals(string? Title)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.FindAllActiveFestivals(Title);
                    if (result[0].Message == "Success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("FindByIDFestivals")]
        [Authorize]
        public async Task<IActionResult> FindByIDFestivals(FestivalsViewEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindByIDFestivals(entity);
                    if (result.Message == "Success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("DeleteFestivals")]
        [Authorize]
        public async Task<IActionResult> DeleteFestivals(FestivalsViewEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.DeleteFestivals(entity);
                    if (result.Message == "Success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("ActiveInActiveFestivals")]
        [Authorize]
        public async Task<IActionResult> ActiveInActiveFestivals(FestivalsViewEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.ActiveInActiveFestivals(entity);
                    if (result.Message == "Success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
