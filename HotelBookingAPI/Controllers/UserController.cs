...
namespace HotelBooking.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(ILogger<UserController> _logger, IUserDomain _UserDomain)
        {
            domain = _UserDomain;
        }
        ...
        [HttpPost("InsertUser")]
        [Authorize]
        public async Task<IActionResult> InsertUser(UsersDataEntity entity)
        {
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.InsertUser(entity);
        ...
        [HttpPost("UpdateUser")]
        [Authorize]
        public async Task<IActionResult> UpdateUser(UsersDataEntity entity)
        {
            try
            {
                var token = HttpContext.Request.Headers["Authorization"]
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.UpdateUser(entity);
        ...
        [HttpPost("DeleteUser")]
        [Authorize]
        public async Task<IActionResult> DeleteUser(UserIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.DeleteUser(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("FindByIDUser")]
        [Authorize]
        public async Task<IActionResult> FindByIDUser(UserIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindByIDUser(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("FindAllUser")]
        [Authorize]
        public async Task<IActionResult> FindAllUser(UserIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindAllUser(entity);
        ...
        [HttpGet("FindAllActiveUser")]
        [Authorize]
        public async Task<IActionResult> FindAllActiveUser()
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindAllActiveUser();
                    if (result[0].Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [Authorize]
        public async Task<IActionResult> ActiveInActiveUser(UserIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.ActiveInActiveUser(entity);
                    if (result.Message == "Success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [Authorize]
        [HttpPost("UserImageUpdate")]
        public async Task<ResultModel> UserImageUpdate([FromForm] UserImageDataEntity docs)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(token))
                {
                    return new ResultModel
                    {
                        ...
                        Status = (int)ResponseStatusCode.Unauthorized
                    };
                }
                ...
                if (docs.UserImage != null && docs.UserImage.Length > 0)
                {
                    string originalFileName = Path.GetFileName(docs.UserImage.FileName);
                    string fileName = Path.GetFileName(originalFileName);

                    physicalFileName = $"{DateTime.Now.Ticks}{Path.GetExtension(fileName)}";
                    string physicalFolderPath = Path.Combine(CommonRepositoryConstants.ImageFilePath, CommonRepositoryConstants.UserImage);
                    ...
                    await docs.UserImage.CopyToAsync(stream);
                }
                else
                {
                    return new ResultModel
                ...
                var result = await domain.UserImageUpdate(physicalFileName, docs.ID, UpdatedBy);
