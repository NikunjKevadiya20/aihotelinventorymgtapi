...
namespace HotelBooking.Controllers
{
    ...
    public class RoomTypeController : Controller
    {
        ...
        private readonly IRoomTypeDomain domain;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public RoomTypeController(ILogger<RoomTypeController> _logger, IRoomTypeDomain _RoomTypeDomain)
        {
            domain = _RoomTypeDomain;
        }
        ...
        [Authorize]
        public async Task<IActionResult> InsertRoomType(RoomTypeDataEntity entity)
        {
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.InsertRoomType(entity);
        ...
        [Authorize]
        public async Task<IActionResult> UpdateRoomType(RoomTypeDataEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.UpdateRoomType(entity);
                    if (result.Message == "success")
                    {
        ...
        [HttpPost("UpdateRoomTypeOccupancy")]
        [Authorize]
        public async Task<IActionResult> UpdateRoomTypeOccupancy(RoomTypeDataEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.UpdateRoomTypeOccupancy(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("UpdateRoomTypeAmenities")]
        [Authorize]
        public async Task<IActionResult> UpdateRoomTypeAmenities(RoomTypeDataEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.UpdateRoomTypeAmenities(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [Authorize]
        public async Task<IActionResult> DeleteRoomType(RoomTypeIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.DeleteRoomType(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        #region Find By ID RoomType
        [HttpPost("FindByIDRoomType")]
        [Authorize]
        public async Task<IActionResult> FindByIDRoomType(RoomTypeIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindByIDRoomType(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        public async Task<IActionResult> FindAllRoomType(RoomTypeIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindAllRoomType(entity);
        ...
        [Authorize]
        public async Task<IActionResult> FindAllActiveRoomType()
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.FindAllActiveRoomType();
                    if (result[0].Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        #region ActiveInActive RoomType
        [HttpPost("ActiveInActiveRoomType")]
        [Authorize]
        public async Task<IActionResult> ActiveInActiveRoomType(RoomTypeIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.ActiveInActiveRoomType(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("InsertRoomTypeBed")]
        [Authorize]
        public async Task<IActionResult> InsertRoomTypeBed(RoomTypeBed entity)
        {
            try
            {
                var token = HttpContext.Request.Headers["Authorization"]
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.InsertRoomTypeBed(entity);
        ...
        [HttpPost("UpdateRoomTypeBed")]
        [Authorize]
        public async Task<IActionResult> UpdateRoomTypeBed(RoomTypeBed entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.UpdateRoomTypeBed(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("DeleteRoomTypeBed")]
        [Authorize]
        public async Task<IActionResult> DeleteRoomTypeBed(RoomTypeBed entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.DeleteRoomTypeBed(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("FindAllRoomTypeBed")]

        public async Task<IActionResult> FindAllRoomTypeBed()
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindAllRoomTypeBed();
                    if (result[0].Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
