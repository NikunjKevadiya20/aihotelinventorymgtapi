...
namespace HotelBooking.Controllers
{
    ...
    public class UserTypeController : ControllerBase
    {
        ...
        public UserTypeController(ILogger<UserTypeController> _logger, IUserTypeDomain _UserTypeDomain)
        {
        ...
        [Authorize]
        public async Task<IActionResult> InsertUserType(UserTypeDataEntity entity)
        {
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.InsertUserType(entity);
        ...
        [Authorize]
        public async Task<IActionResult> UpdateUserType(UserTypeDataEntity entity)
        {
            try
            {
                var token = HttpContext.Request.Headers["Authorization"]
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.UpdateUserType(entity);
        ...
        [Authorize]
        public async Task<IActionResult> DeleteUserType(UserTypeIDEntity entity)
        {
            ...
            try
            {
             ...
             .FirstOrDefault()?.Split(" ").Last();
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.DeleteUserType(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("FindByIDUserType")]
        [Authorize]
        public async Task<IActionResult> FindByIDUserType(UserTypeIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindByIDUserType(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("FindAllUserType")]
        [Authorize]
        public async Task<IActionResult> FindAllUserType(UserTypeIDEntity entity)
        {
            ...
            try
            {
             ...
             .FirstOrDefault()?.Split(" ").Last();
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindAllUserType(entity);
        ...
        [HttpGet("FindAllActiveUserType")]
        [Authorize]
        public async Task<IActionResult> FindAllActiveUserType()
        {
            try
            {
                var token = HttpContext.Request.Headers["Authorization"]
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindAllActiveUserType();
                    if (result[0].Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("ActiveInActiveUserType")]
        [Authorize]
        public async Task<IActionResult> ActiveInActiveUserType(UserTypeIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.ActiveInActiveUserType(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
