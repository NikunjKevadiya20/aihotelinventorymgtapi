...
namespace HotelBooking.Controllers
{
    ...
    {
        private readonly IOTADomain domain;

        private readonly IWebHostEnvironment _webHostEnvironment;

        public OTAController(ILogger<OTAController> _logger, IOTADomain _OTADomain)
        {
            domain = _OTADomain;
        }
        ...
        [HttpPost("InsertOTA")]
        [Authorize]
        public async Task<IActionResult> InsertOTA(OTAEntity entity)
        {
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.InsertOTA(entity);
        ...
        [HttpPost("UpdateOTA")]
        [Authorize]
        public async Task<IActionResult> UpdateOTA(OTAEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.UpdateOTA(entity);
                    if (result.Message == "success")
                    {
        ...
        [HttpPost("DeleteOTA")]
        [Authorize]
        public async Task<IActionResult> DeleteOTA(OTAIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.DeleteOTA(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        #region Find By ID OTA
        [HttpPost("FindByIDOTA")]
        [Authorize]
        public async Task<IActionResult> FindByIDOTA(OTAIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindByIDOTA(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        [HttpPost("FindAllOTA")]
        [Authorize]
        public async Task<IActionResult> FindAllOTA(OTAIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.FindAllOTA(entity);
        ...
        [HttpGet("FindAllActiveOTA")]

        public async Task<IActionResult> FindAllActiveOTA()
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    var result = await domain.FindAllActiveOTA();
                    if (result[0].Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
        ...
        #region ActiveInActive OTA
        [HttpPost("ActiveInActiveOTA")]
        [Authorize]
        public async Task<IActionResult> ActiveInActiveOTA(OTAIDEntity entity)
        {
            ...
            try
            {
                ...
                if (userId != 0)
                {
                    ...
                    var result = await domain.ActiveInActiveOTA(entity);
                    if (result.Message == "success")
                    {
                        return StatusCode((int)HttpStatusCode.OK, new ResultModel()
                        {
